...
def game_over_scene(final_score):
    ...
    # turn oof sound from last scene
    sound = ugame.audio
    sound.stop()
    ...
    game.layers = text + [background]
    # render the background and initial location of sprite list# most likely you will only render background once per scene
    game.render_block()
    
    # repest forever, game loop
    while True:
        # get user input
        keys = ugame.buttons.get_pressed()
